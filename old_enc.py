...
while buffer!=0:
	...
	failure to do so the data cannot be reverted back ever again.''')
            ...
            fname='E:\\Learn Hub\\Go Programming Language Tutorial - Golang Tutorial For Beginners - Go Language Training - Edureka - YouTube.mkv.aes'
            print(fname)
            if fname[-4:]=='.aes':
...
'''     /-FDk+u2%~j&Lt78I#Pp*Qe(SGBJYO   

E:\Learn Hub\Go Programming Language Tutorial - Golang Tutorial For Beginners - Go Language Training - Edureka - YouTube.mkv.aes
      '''